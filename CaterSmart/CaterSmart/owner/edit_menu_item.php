...
<head>
    ...
    <title>Edit Menu Item - CaterSmart</title>
        ...
        <div class="max-w-2xl mx-auto">
            <div class="glass-effect rounded-xl shadow-md p-6 border border-gray-200 dark:border-gray-700 animate-slide-up">
                <div class="flex justify-between items-center mb-6">
                    <h2 class="text-2xl font-bold text-gray-900 dark:text-white">Edit Menu Item</h2>
                </div>
                ...
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"] . "?id=" . $id); ?>" method="post" class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea id="description" 
                                  name="description" 
                                  rows="3" 
                                  class="mt-1 block w-full rounded-lg border-gray-300 dark:border-gray-600 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:text-gray-300 transition-colors duration-300"><?php echo htmlspecialchars($menu_item["description"]); ?></textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <select id="category" 
                            ...
                            <option value="main_course" <?php echo $menu_item["category"] == "main_course" ? "selected" : ""; ?>>Main Course</option>
                            ...
                            <option value="special_items" <?php echo $menu_item["category"] == "special_items" ? "selected" : ""; ?>>Special Items</option>
                        </select>
                    </div>
