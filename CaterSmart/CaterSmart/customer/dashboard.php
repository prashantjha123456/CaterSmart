...
<body class="bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-gray-900 dark:to-indigo-900 min-h-screen dark-mode-transition">
                ...
                <div class="mt-6 border-t pt-4 dark:border-gray-700">
                    ...
                    <div id="qrPaymentSection" class="mb-4 hidden">
                        ...
                        <?php if (!empty($qr_code)): ?>
                            <div class="text-center p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                ...
                                <p class="text-xs text-gray-500 dark:text-gray-400 mt-2">After scanning, please enter the transaction reference below</p>
                            </div>
                        <?php else: ?>
                    ...
                    <div id="bankTransferSection" class="mb-4 hidden">
                        <div class="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                            ...
                            <p class="text-xs text-gray-500 dark:text-gray-400 mt-2">After transfer, please enter the transaction reference below</p>
                        </div>
                    </div>
                    ...
                    <div id="paymentReferenceSection" class="mb-4 hidden">
                        <label class="block text-gray-700 dark:text-gray-300 text-sm font-bold mb-2" for="payment_reference">Transaction Reference</label>
                        <input type="text" name="payment_reference" id="payment_reference" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 dark:text-gray-300 dark:bg-gray-700 dark:border-gray-600 leading-tight focus:outline-none focus:shadow-outline focus:ring-2 focus:ring-indigo-500 transition duration-300">
                    </div>
                </div>
    ...
    <script>
        ...
        function validateForm() {
            ...
            // Check for payment reference if QR or bank transfer
            if ((paymentMethod === 'qr' || paymentMethod === 'bank') && !document.getElementById('payment_reference').value) {
